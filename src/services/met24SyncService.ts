...
class MET24SyncService {
  ...
  async syncDomains(): Promise<SyncResponse> {
    try {
      ...
      logger.info('Starting Universele Levensboom sync', { timestamp: Date.now() });
      ...
      logger.info('Universele Levensboom sync completed', { 
      ...
      logger.error('Universele Levensboom sync failed', { 
