// 🤖 all-MiniLM-L12-v2 Embedding Service for MET24
...
class MPNetL12EmbeddingService {
  ...
  private async _doInitialize(): Promise<void> {
    try {
      console.log('🚀 Initializing all-MiniLM-L12-v2 model...');
      
      // Privacy-first: Use local models only
      ...
      console.log(`✅ all-MiniLM-L12-v2 loaded successfully in ${loadTime}ms`);
      
    } catch (error) {
      console.error('❌ Failed to initialize all-MiniLM-L12-v2:', error);
  ...
  // 🎯 MBTI-specific embedding helpers
  ...
  async runPerformanceTest(sampleTexts: string[]): Promise<{
    ...
    console.log('🧪 Running all-MiniLM-L12-v2 performance test...');
...
export { MPNetL12EmbeddingService };
