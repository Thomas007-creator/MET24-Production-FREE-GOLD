/**
 * V14 Extensions Demo Component - BMAD Optimized
 * 
 * Demonstratie van hoe je de nieuwe V14 Future Extensions kunt gebruiken
 * Fully refactored using BMAD composition patterns - under 100 lines per component
 * 
 * @version 14.2.0
...
// ================================================
// BMAD Extensions List Component
// ================================================
...
const ExtensionsList: React.FC = () => {
  ...
  if (isLoading) {
    return <p className="text-gray-500 text-center py-8">Loading extensions...</p>;
  }
...
// ================================================
// BMAD Available Extensions Component
// ================================================

const AvailableExtensions: React.FC = () => {
  const { createExtension } = useExtensions();
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {defaultExtensions.map((extension) => (
        <AvailableExtensionCard
          ...
          extension={extension}
          onInstall={() => createExtension(extension)}
        />
      ))}
    </div>
  );
