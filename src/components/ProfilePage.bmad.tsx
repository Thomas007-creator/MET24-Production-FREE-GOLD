/**
 * Profile Page - BMAD Refactored
 * 
 * React component voor user profile management
...
interface ProfileContextType {
  ...
  mbtiInsights: MBTIInsight;
  activeTab: string;
  setActiveTab: (tab: string) => void;
}

// ================================================
// BMAD Profile Context & Provider
// ================================================
...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ onEdit, onAvatarEdit }) => {
  const { userData, mbtiInsights } = useProfile();
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm text-gray-400">
              ...
              <div className="flex items-center gap-1">
                ...
                {userData?.privacy === 'public' ? 'Openbaar' : 'Privé'}
              </div>
            </div>
...
// ================================================
// BMAD Profile Navigation Component
// ================================================
...
// ================================================
// BMAD Profile Stats Component
// ================================================

const ProfileStats: React.FC = () => {
  const { personalStats } = useProfile();
...
// ================================================
// BMAD Profile Achievements Component
// ================================================
...
// ================================================
// BMAD Profile MBTI Insights Component
// ================================================

const ProfileMBTIInsights: React.FC = () => {
  const { mbtiInsights } = useProfile();
...
// ================================================
// BMAD Profile Activity Component
// ================================================
...
// ================================================
// BMAD Profile Edit Modal Component
// ================================================
...
const ProfileEditModal: React.FC<ProfileEditModalProps> = ({ isOpen, onClose }) => {
  const { editForm, setEditForm, handleSaveProfile } = useProfile();
  ...
  const mbtiTypes = ['INFP', 'INFJ', 'ENFP', 'ENFJ', 'INTJ', 'INTP', 'ENTP', 'ENTJ', 'ISFP', 'ISFJ', 'ESFP', 'ESFJ', 'ISTP', 'ISTJ', 'ESTP', 'ESTJ'];
...
// ================================================
// BMAD Profile Tab Content Component
// ================================================
...
// ================================================
// BMAD Main Profile Page Component
// ================================================
    ...
    <div className="min-h-screen p-4">
      <div className="max-w-6xl mx-auto">
        ...
        <ProfileHeader 
          ...
          onAvatarEdit={() => setIsAvatarModalOpen(true)}
        />
        <ProfileNavigation />
        <ProfileTabContent />
...
// ================================================
// BMAD Main Profile Page Component with Provider
// ================================================
...
export const ProfileComponents = {
  ...
  MBTIInsights: ProfileMBTIInsights,
