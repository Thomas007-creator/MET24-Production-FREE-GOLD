-- 🚀 MPNet L12-v2 Database Migration Script - FIXED VERSION
...
-- This version removes problematic RLS policies for clean deployment
...
BEGIN
    ...
    WHERE 
        ...
        AND ve.created_at >= NOW() - INTERVAL '%d days' % days_back
    GROUP BY 
        ve.model_name,
        CASE 
            WHEN ve.embedding_384 IS NOT NULL THEN 384
...
BEGIN
    ...
    AND column_name IN ('embedding_384', 'model_name', 'inference_time_ms', 'quality_score');
