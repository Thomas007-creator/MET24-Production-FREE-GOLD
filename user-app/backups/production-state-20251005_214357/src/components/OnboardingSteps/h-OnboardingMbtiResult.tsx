  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex flex-col justify-center items-center text-white font-sans p-8'>
      <div className='text-center max-w-2xl'>
        ...
        <div className='mb-10'>
          {/* MBTI Result Icon */}
          <div className='w-24 h-24 bg-white/20 backdrop-blur-xl border border-white/30 rounded-3xl flex items-center justify-center mx-auto mb-6'>
            <span className='text-4xl font-bold tracking-widest'>
              {result.letters}
            </span>
          </div>

          <h1 className='text-4xl font-bold mb-4'>Jouw MBTI‑inschatting</h1>
        </div>
