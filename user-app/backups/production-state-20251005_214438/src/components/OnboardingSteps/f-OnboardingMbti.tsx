    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex flex-col justify-center items-center text-white font-sans p-8'>
      <div className='max-w-4xl w-full bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
          {/* AI Recommendation */}
          <Card 
            className='bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg p-6 cursor-pointer hover:scale-105 transition-transform'
            isPressable
          ...
          {/* Known MBTI */}
          <Card 
            className='bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-lg p-6 cursor-pointer hover:scale-105 transition-transform'
            isPressable
          ...
          {/* Quick Test */}
          <Card 
            className='bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg p-6 cursor-pointer hover:scale-105 transition-transform'
            isPressable
