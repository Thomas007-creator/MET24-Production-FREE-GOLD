...
export default class AdaptiveSessionData extends Model {
  ...
  // Learning data
  @json('user_preferences') userPreferences!: Record<string, any>;
  @json('effective_patterns') effectivePatterns!: string[]; // What worked well
  @json('ineffective_patterns') ineffectivePatterns!: string[]; // What didn't work
