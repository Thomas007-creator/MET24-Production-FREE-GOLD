  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-indigo-600 flex flex-col justify-center items-center text-white font-sans p-8">
      <div className="max-w-2xl w-full">
        ...
        {/* Main Content */}
        <div className="mb-8 p-8 bg-blue-900/10 backdrop-blur-xl border border-blue/20 rounded-3xl">
          ...
          <div className="mb-6">
            ...
            <Input
              ...
              classNames={{
                input: "text-center text-2xl font-mono tracking-widest bg-blue-500/10 border-blue-300/30 text-white placeholder-white/50",
                inputWrapper: "bg-blue-500/10 backdrop-blur-xl border border-blue-300/30"
              }}
          ...
          {/* Info Box */}
          <div className="mt-6 p-4 bg-blue-500/10 rounded-xl border border-blue-300/30">
