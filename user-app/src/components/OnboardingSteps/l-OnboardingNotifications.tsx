        ...
        <div className='mb-8 p-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl'>
          ...
          <div className='mb-8'>
            ...
            <div className='grid gap-4 md:grid-cols-2'>
              <div className='flex items-start gap-3 p-4 bg-violet-800/10 rounded-xl'>
          ...
          <div className='space-y-4'>
            <Button
              ...
              className={`w-full h-16 text-lg font-semibold transition-all duration-200 ${
                !isSubmitting
                  ? 'bg-purple-800/20 backdrop-blur-xl border border-purple/30 text-white shadow-lg hover:shadow-xl'
            ...
            <Button
              ...
              className={`w-full h-16 text-lg font-semibold transition-all duration-200 ${
                !isSubmitting
                  ? 'bg-violet-600/20 backdrop-blur-xl border border-violet/30 text-white hover:bg-violet-600/30'
                  : 'bg-gray-400 text-gray-600 cursor-not-allowed'
              }`}
            >
              <div className='flex items-center gap-3'>
            ...
            <Button
              ...
              className={`w-full h-16 text-lg font-semibold transition-all duration-200 ${
                !isSubmitting
                  ? 'bg-violet-500/10 backdrop-blur-xl border border-violet/20 text-white hover:bg-violet-500/20'
                  : 'bg-gray-400 text-gray-600 cursor-not-allowed'
              }`}
            >
              <div className='flex items-center gap-3'>
