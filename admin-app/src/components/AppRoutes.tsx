...
const LoadingSpinner: React.FC = () => (
  <div className='min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex flex-col justify-center items-center text-white font-sans relative overflow-hidden'>
...
const AppRoutes: React.FC = () => {
  ...
  const handleOnboardingComplete = (userData?: any) => {
    logger.info('Onboarding completed!', { userData });
    localStorage.setItem('onboarding_completed', 'true');
    localStorage.setItem('onboarding_user_data', JSON.stringify(userData || {}));
      ...
      <Routes>
        ...
        {!onboardingCompleted && (
          <>
            ...
            <Route path='/practical-applications' element={
              <React.Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white">Loading...</div>}>
        ...
        {onboardingCompleted && (
          <>
            ...
            <Route path='/met24-domains' element={<MET24DomainsPage />} />
